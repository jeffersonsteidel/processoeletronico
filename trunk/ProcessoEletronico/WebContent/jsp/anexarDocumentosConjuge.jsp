...
<f:view>
	...
	<a4j:form id="form">
		<center><rich:panel id="painelPai">
			...
			<font size="2"><b>ADICIONAR DOCUMENTOS - CÔNJUGE</b></font>
			...
			<h:panelGrid columns="3" id="titular">
				...
				<a4j:support event="onchange"
						action="#{documentoImagemController.listarDocumentosConjuge}"
			...
			<center><h:panelGrid columns="1" id="documentos">
				<h:outputText value="Documentos já anexados:"
					rendered="#{not empty documentoImagemController.documentoList && documentoImagemController.documentoImagem.conjuge.codigo != null}" />
				<h:outputText styleClass="negrito"
					value="Nenhum Documento para este Emprego!"
					rendered="#{empty documentoImagemController.documentoList  && documentoImagemController.documentoImagem.conjuge.codigo != null}" />

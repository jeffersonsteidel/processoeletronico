	...
	<a4j:form id="form">
		<center><rich:panel>
			...
			<h:panelGrid columns="1">
				<h:outputText
					value="Solicitante: #{solicitacaoController.solicitacaoRessarcimentoSaude.solicitante.siape} - #{solicitacaoController.solicitacaoRessarcimentoSaude.solicitante.nome}">
				</h:outputText>
			</h:panelGrid>
			...
			<h:panelGrid columns="2">
				...
				<rich:calendar
					value="#{solicitacaoController.solicitacaoRessarcimentoSaude.dataPagamento}"
				...
				<h:outputText
					value="#{solicitacaoRessarcimentoSaudeController.solicitacaoRessarcimentoSaude.valor}"></h:outputText>
				<h:outputText value="Valor da Tabela: " />
				<h:inputText disabled="true"
					value="#{solicitacaoRessarcimentoSaudeController.solicitacaoRessarcimentoSaude.valorPago}"

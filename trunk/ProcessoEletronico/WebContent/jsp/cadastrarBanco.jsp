...
<f:view>
	...
	<center><a4j:form id="form">
		<rich:panel header="Banco" style="width: 1080px;">
			<h:panelGrid columns="2">

				<h:outputText value="Banco: " />
				<h:inputText value="#{bancoController.banco.descricao}" size="50"
					maxlength="100" required="true"
					requiredMessage="Campo Banco obrigatório!"></h:inputText>
			</h:panelGrid>
			<a4j:commandButton value="Salvar" action="#{bancoController.salvar}"

...
<f:view>
	<center><a4j:form id="form">
		<rich:panel header="Bancos"
			...
			<rich:dataTable id="listaBancos" value="#{bancoController.bancoList}"
				...
				<rich:column>
					...
					<a4j:commandLink action="#{bancoController.carregar}"
						reRender="listaBancos" ajaxSingle="true">
						<h:graphicImage value="../images/edit.gif" style="border:0"
							width="20" height="18" id="editar" />
						<f:setPropertyActionListener value="#{list.codigo}"
							target="#{bancoController.banco.codigo}" />
					</a4j:commandLink>

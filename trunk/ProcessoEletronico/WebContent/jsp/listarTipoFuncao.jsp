...
<f:view>
	<center><a4j:form id="form">
		<rich:panel header="Tipos de Função"
			...
			<rich:dataTable id="listaTiposFuncao" value="#{tipoFuncaoController.tipoFuncaoList}"
				...
				<rich:column>
					...
					<a4j:commandLink action="#{tipoFuncaoController.carregar}"
						reRender="listaTiposFuncao" ajaxSingle="true">
						<h:graphicImage value="../images/edit.gif" style="border:0"
							width="20" height="18" id="editar" />
						<f:setPropertyActionListener value="#{list.codigo}"
							target="#{tipoFuncaoController.tipoFuncao.codigo}" />
					</a4j:commandLink>

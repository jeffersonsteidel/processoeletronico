...
<f:view>
	...
	<center><a4j:form id="form">
		<rich:panel header="Tipo de Função" style="width: 1080px;">
			<h:panelGrid columns="2">

				<h:outputText value="Tipo de Função: " />
				<h:inputText value="#{tipoFuncaoController.tipoFuncao.descricao}" size="50"
					maxlength="100" required="true"
					requiredMessage="Campo Tipo de Função obrigatório!"></h:inputText>
			</h:panelGrid>
			<a4j:commandButton value="Salvar" action="#{tipoFuncaoController.salvar}"

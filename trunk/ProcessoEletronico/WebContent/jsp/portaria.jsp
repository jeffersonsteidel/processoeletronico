	...
	<a4j:form id="form">
		<center><rich:panel>
			...
			<h:panelGrid columns="2">
				...
				<h:inputText
					value="#{portariaController.portaria.nome}"
				...
				<h:inputText
					value="#{portariaController.portaria.numero}"
					size="53" maxlength="11" required="true"
					requiredMessage="Campo Numero da Portaria é obrigatório!">
				</h:inputText>
				<h:outputText value="Data da Portaria: "></h:outputText>
				<rich:calendar
					value="#{portariaController.portaria.data}"
				...
				<h:selectOneMenu
						value="#{portariaController.portaria.tipo.codigo}"
						required="true"
				...
				<h:inputText
					value="#{portariaController.portaria.tipo.descricao}"
					size="53" maxlength="120" required="true"
				...
				<h:selectOneMenu value="#{portariaController.portaria.local}"
						required="true" requiredMessage="Campo Local da Portaria é obrigatório!">
						<f:selectItem itemLabel="SELECIONE" itemValue="" />
			...
			<a4j:commandButton value="Salvar"
				action="#{portariaController.salvar}"
				reRender="form" />

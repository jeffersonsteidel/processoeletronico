		...
		<center><rich:panel>
			...
			<h:panelGrid columns="4">
				<center><h:outputText value="Atividades: " /> <h:inputTextarea
					value="#{empregoController.emprego.atividades}" rows="10" cols="50"
					required="true"
			...
			<h:panelGrid columns="2">
				<a4j:commandButton value="Adicionar"
					action="#{empregoController.salvarEmprego}" reRender="form" />
			</h:panelGrid>

			<rich:dataTable id="listaEmpregos"
				value="#{empregoController.listaEmpregos}" var="list" width="1150px"

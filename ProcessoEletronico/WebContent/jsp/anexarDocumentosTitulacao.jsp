		...
		<center><rich:panel id="painelPai">
			...
			<center><h:panelGrid columns="1" id="documentos">
				<h:outputText value="Documentos já anexados:"
					rendered="#{not empty documentoImagemController.documentoList && documentoImagemController.documentoImagem.servidorTitulacao.codigo != null}" />
				<h:outputText styleClass="negrito"
					value="Nenhum Documento para este Emprego!"
					rendered="#{empty documentoImagemController.documentoList  && documentoImagemController.documentoImagem.servidorTitulacao.codigo != null}" />
			...
			<h:selectOneMenu
				...
				<f:selectItem itemLabel="SELECIONE" itemValue="" />
				<f:selectItem itemLabel="HISTÓRICO ESCOLAR" itemValue="5" />
				<f:selectItem itemLabel="DIPLOMA" itemValue="12" />
			</h:selectOneMenu>
